                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <form method="POST"  class="form-horizontal form-label-left" enctype="multipart/form-data" action="updateadmin.php">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter your email."></i> 
                                    <input type="email" class="form-control" value="<?php echo $rowadmin['email']; ?>" name="email" required placeholder="Enter your email.">
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputEmail1">Full Name</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter your full name."></i> 
                                    <input type="text" class="form-control" value="<?php echo $rowadmin['name']; ?>" name="name" placeholder="Enter your full name." required >
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Address</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter your address."></i> 
                                    <input type="text" class="form-control" value="<?php echo $rowadmin['address']; ?>" name="address" placeholder="Enter your address." required >
                                </div>            

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Phone</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter your phone no."></i> 
                                    <input type="text" class="form-control" value="<?php echo $rowadmin['phone']; ?>" name="phone" placeholder="Enter your phone no." required >
                                </div>             



                                <div class="form-group">
                                    <label for="exampleInputEmail1">Profile Picture</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Upload your profile picture."></i> 
