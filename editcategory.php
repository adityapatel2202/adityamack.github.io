...
<br>
     ...
     <form role="form" action="edit-cat.php?id=<?php echo base64_encode($id); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  value="<?php echo $resultcheck['category_name']; ?>" name="catname" required="required" placeholder="Enter category name.">
                </div>
