...
$pstatus='Available';
$qry = "SELECT * FROM app_productsrec WHERE product_status='".$pstatus."' order by id DESC ";
$res1 = mysqli_query($conn, $qry);
$recomcounter = mysqli_num_rows($res1);
if ($recomcounter > 0) {
    ...
    $final = json_encode(array("success" => 'true', "rcomitem" => $json1));
    print_r($final);
    unset($final);
    unset($json1);
    mysqli_close($conn);
    ...
    $minfo = array("success" => 'false', "message" => 'No Recommended Item Found ');
