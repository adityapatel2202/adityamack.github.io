...
$message .= '  <center>Hi '.strip_tags($username).',  <br><br>Your profile has been updated successfully for Food Ordering App Demo.<br><br>Thanks for taking your time to update your profile.';
                  $message .= file_get_contents('emailfoot.php');
	include 'mailconfig.php';
	$mail->Subject = "Account Updatation Email For Food Ordering App Demo ";
...
}else{ $minfo = array("success"=>'false', "message"=>'Please verify your e-mail first ');
      $jsondata = json_encode($minfo); print_r($jsondata); mysqli_close($conn); exit();  }
