            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="message"><center><h5><?php   if (isset($_SESSION['message'])) echo $_SESSION['message']; ?></h5></center></div>
                        <ul id="registration-step">
                            <li id="account" class="highlight">Menu Item Details</li>
                            <li id="password">Primary-Image</li>
                            <li id="general">Optional Images</li>
                        </ul>
                        <form name="frmRegistration" id="registration-form" method="post" action="item-update.php">
...
<label>Optional Images:</label><br>
    ...
    <?php
    } else { echo ' <center><span class="label label-danger">You have used your image limit(' . $imagehandel . ' images for single product please delete one and try )</span></center>';
    }
    ?>
